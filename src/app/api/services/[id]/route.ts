  ...
  try {
    ...
    const service = await prisma.service.update({
      ...
      data: {
        ...
        finalPriceTTC: json.finalPriceTTC !== undefined ? requireNumber(json.finalPriceTTC, "Prix final") : undefined,
        suggestedPriceTTC: json.suggestedPriceTTC !== undefined ? requireNumber(json.suggestedPriceTTC, "Prix suggéré") : undefined,
        pricingMode: json.pricingMode !== undefined ? json.pricingMode : undefined,
        vatRate: json.vatRate !== undefined ? requireNumber(json.vatRate, "Taux TVA") : undefined,
